...
export default function AddUser() {
  ...
  const birthList = () => {
    ...
    const years = [];
    for (let y = minBirth; y <= currentYear - maxBirthRang; y++) years.push(y);
  ...
  const [birth, setBirth] = useState(2017);
        ...
        <div className={styles["content"]}>
          ...
          <div className={styles["row"]}>
            ...
            <div className={styles["input"]}>
              ...
              <input
                className={
                  avatarErr || avatarErr === "Max size err"
              ...
              {!(avatarErr === "Max size err") || (
                <label>{"File size <= 3MB"}</label>
              )}
            </div>
          </div>
          <div className={styles["row-textarea"]}>
            ...
            <div className={styles["input"]}>
              <textarea
                className={noteErr ? "form-control is-invalid" : "form-control"}
                name="note"
                onChange={onChange}
              />
          ...
          <div className={styles["btns"]}>
            <div>
              <Link href="/admin/list-user">
                <a>Cancel</a>
              </Link>
            </div>
            <div onClick={onSubmit}>Add User</div>
          </div>
        </div>
      </div>
    </>
